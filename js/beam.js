...
//                os = [
//                    { name: "Christoph", amount: 10 },
//                    { name: "Gabi", amount: 15 },
//                    { name: "GRuth", amount: 12 }
//                ];
        ...
        show: function(f) {
            ...
            Fs.getJ('BeamTransactions', function(os) {
                ...
                for(var i = 0; i < os.length; i++) {
                    ...
                    $li.appendTo(self.$me.find('ul').first()).show();
                }
            });
...
//    });                
            ...
            var fPick = function(onDone) {
                ...
                navigator.contacts.pickContact(function (o) {
                    setTimeout(function () {
    //                    alert(o.displayName + " " + o.emailAddress + " " + o.phoneNr );
                        ...
                        if(o.phoneNumbers && o.phoneNumbers.length) {
                            for(var i = 0; i < o.phoneNumbers.length; i++) {
                                var n = o.phoneNumbers[i];
                                n = n.replace(/^0(1)/, '+49$1');
                                if(n.match(/^\+49(14|15|16|17)/)) {
                                    number = n;
                                    break;
                                }
                            }
                        ...
                        if(!number) {
                            jAlert('Wähle einen Kontakt mit einer Handynummer!', function() {
                                Header.back();
                            });
...
function syncContacts() {
    ...
    navigator.contacts.find(fields, function(os) {
        var contacts = {};
        for(var i = 0; i < os.length; i++) {
            var o = os[i];
...
//        }
    ...
    }, function() { l('error searching'); }, options);
}
